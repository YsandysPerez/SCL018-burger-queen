...
export const Inicio = () => {
  return (
    ...
    <div className="m-20">
      ...
      <Link to="/Garzon"><button className="h-20 px-20 font-semibold text-lg text-teal-50 transition-colors duration-150 bg-yellow-500 rounded-lg focus:shadow-outline hover:bg-yellow-600">Garzón</button></Link>
